    ...
    internal sealed class Vns430Workflow
    {
        ...
        internal static Vns430Workflow Create(Vns430WorkflowKind kind, Vns430BackendSnapshot snapshot)
        {
            ...
            return kind switch
            {
                ...
                Vns430WorkflowKind.AocMetar => new() { Kind = kind, Title = "METAR REQUEST", Fields = { Text("STATION", "STATION", 4, true, station), Options("SOURCE", "SOURCE", "VATSIM", "REAL WORLD", "SAYINTENTIONS") } },
                Vns430WorkflowKind.AocAtis => new() { Kind = kind, Title = "ATIS REQUEST", Fields = { Text("STATION", "STATION", 4, true, station), Options("SOURCE", "SOURCE", "VATSIM", "REAL WORLD", "SAYINTENTIONS"), Options("TYPE", "ATIS TYPE", "ARRIVAL", "DEPARTURE"), Options("AUTO", "AUTO REFRESH", "OFF", "ON") } },
